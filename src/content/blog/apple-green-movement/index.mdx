...
description: The exclusion of familiar accessories from the newer iPhone boxes and its impact on the industry, the consumers, and the environment.
date: 2024-09-29
tags: ['tech', 'opinion']
...
<Callout title="Heads-up! Why this article exists." variant="note" defaultOpen={false}>
  This article was penned on this same day in 2021 as part of my highschool writing assignment, which contains every so often grammatical mistakes and incompetent ways with words ^^ Nonetheless, I still think it's a good read, good topic that I did real good research on, so enjoy your stay!
</Callout>
